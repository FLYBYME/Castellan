/**
 * ext.castellan.genesis — System Genesis extension with interactive wizard UI.
 *
 * Provides a Genesis Dashboard view that allows users to run Genesis (soul/agent generation),
 * Bootstrap (tool provisioning), and Reset directly from the IDE with real-time streaming.
 */
...
class GenesisDashboardViewProvider implements ViewProvider {
...
class ManagerExtension {
    public activate(context: ExtensionContext): void {
        context.ide.views.registerProvider('left-panel', new GenesisDashboardViewProvider(context));
    ...
    public deactivate(): void {
        console.log('[ManagerExtension] Deactivated');
    }
}
