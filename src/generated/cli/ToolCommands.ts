...
export function registerGeneratedCommands(program: Command, client: CastellanClient) {
    ...
    cmd_agent_agentRunContract_run.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent:run...' + C.reset);
            const res = await client.api.agent.run(ZodToCliMapper.parseOptions(o, Contract_0.agentRunContract.inputSchema));
    ...
    cmd_agent_agentStructuredInferContract_structured_infer.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent:structured_infer...' + C.reset);
            const res = await client.api.agent.structured_infer(ZodToCliMapper.parseOptions(o, Contract_0.agentStructuredInferContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_agent_agentCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent:create...' + C.reset);
            const res = await client.api.agent.create(ZodToCliMapper.parseOptions(o, Contract_0.agentCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_agent_agentCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent:find...' + C.reset);
            const res = await client.api.agent.find(ZodToCliMapper.parseOptions(o, Contract_0.agentCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_agent_agentCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent:find_one...' + C.reset);
            const res = await client.api.agent.find_one(ZodToCliMapper.parseOptions(o, Contract_0.agentCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_agent_agentCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent:count...' + C.reset);
            const res = await client.api.agent.count(ZodToCliMapper.parseOptions(o, Contract_0.agentCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_agent_agentCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent:get...' + C.reset);
            const res = await client.api.agent.get(ZodToCliMapper.parseOptions(o, Contract_0.agentCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_agent_agentCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent:update...' + C.reset);
            const res = await client.api.agent.update(ZodToCliMapper.parseOptions(o, Contract_0.agentCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_agent_agentCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent:delete...' + C.reset);
            const res = await client.api.agent.delete(ZodToCliMapper.parseOptions(o, Contract_0.agentCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_agent_run_agentRunCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent_run:create...' + C.reset);
            const res = await client.api.agent_run.create(ZodToCliMapper.parseOptions(o, Contract_0.agentRunCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_agent_run_agentRunCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent_run:find...' + C.reset);
            const res = await client.api.agent_run.find(ZodToCliMapper.parseOptions(o, Contract_0.agentRunCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_agent_run_agentRunCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent_run:find_one...' + C.reset);
            const res = await client.api.agent_run.find_one(ZodToCliMapper.parseOptions(o, Contract_0.agentRunCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_agent_run_agentRunCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent_run:count...' + C.reset);
            const res = await client.api.agent_run.count(ZodToCliMapper.parseOptions(o, Contract_0.agentRunCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_agent_run_agentRunCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent_run:get...' + C.reset);
            const res = await client.api.agent_run.get(ZodToCliMapper.parseOptions(o, Contract_0.agentRunCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_agent_run_agentRunCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent_run:update...' + C.reset);
            const res = await client.api.agent_run.update(ZodToCliMapper.parseOptions(o, Contract_0.agentRunCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_agent_run_agentRunCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing agent_run:delete...' + C.reset);
            const res = await client.api.agent_run.delete(ZodToCliMapper.parseOptions(o, Contract_0.agentRunCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_cronTriggerContract_trigger.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron:trigger...' + C.reset);
            const res = await client.api.cron.trigger(ZodToCliMapper.parseOptions(o, Contract_1.cronTriggerContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_cronResetContract_reset.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron:reset...' + C.reset);
            const res = await client.api.cron.reset(ZodToCliMapper.parseOptions(o, Contract_1.cronResetContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_cronStatusContract_status.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron:status...' + C.reset);
            const res = await client.api.cron.status(ZodToCliMapper.parseOptions(o, Contract_1.cronStatusContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_cronJobCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron:create...' + C.reset);
            const res = await client.api.cron.create(ZodToCliMapper.parseOptions(o, Contract_1.cronJobCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_cronJobCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron:find...' + C.reset);
            const res = await client.api.cron.find(ZodToCliMapper.parseOptions(o, Contract_1.cronJobCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_cronJobCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron:find_one...' + C.reset);
            const res = await client.api.cron.find_one(ZodToCliMapper.parseOptions(o, Contract_1.cronJobCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_cronJobCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron:count...' + C.reset);
            const res = await client.api.cron.count(ZodToCliMapper.parseOptions(o, Contract_1.cronJobCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_cronJobCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron:get...' + C.reset);
            const res = await client.api.cron.get(ZodToCliMapper.parseOptions(o, Contract_1.cronJobCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_cronJobCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron:update...' + C.reset);
            const res = await client.api.cron.update(ZodToCliMapper.parseOptions(o, Contract_1.cronJobCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_cronJobCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron:delete...' + C.reset);
            const res = await client.api.cron.delete(ZodToCliMapper.parseOptions(o, Contract_1.cronJobCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_runs_cronJobRunCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron_runs:create...' + C.reset);
            const res = await client.api.cron_runs.create(ZodToCliMapper.parseOptions(o, Contract_1.cronJobRunCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_runs_cronJobRunCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron_runs:find...' + C.reset);
            const res = await client.api.cron_runs.find(ZodToCliMapper.parseOptions(o, Contract_1.cronJobRunCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_runs_cronJobRunCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron_runs:find_one...' + C.reset);
            const res = await client.api.cron_runs.find_one(ZodToCliMapper.parseOptions(o, Contract_1.cronJobRunCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_runs_cronJobRunCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron_runs:count...' + C.reset);
            const res = await client.api.cron_runs.count(ZodToCliMapper.parseOptions(o, Contract_1.cronJobRunCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_runs_cronJobRunCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron_runs:get...' + C.reset);
            const res = await client.api.cron_runs.get(ZodToCliMapper.parseOptions(o, Contract_1.cronJobRunCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_runs_cronJobRunCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron_runs:update...' + C.reset);
            const res = await client.api.cron_runs.update(ZodToCliMapper.parseOptions(o, Contract_1.cronJobRunCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_cron_runs_cronJobRunCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing cron_runs:delete...' + C.reset);
            const res = await client.api.cron_runs.delete(ZodToCliMapper.parseOptions(o, Contract_1.cronJobRunCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_demo_demoHelloContract_hello.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing demo:hello...' + C.reset);
            const res = await client.api.demo.hello(ZodToCliMapper.parseOptions(o, Contract_2.demoHelloContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_demo_demoStatusContract_status.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing demo:status...' + C.reset);
            const res = await client.api.demo.status(ZodToCliMapper.parseOptions(o, Contract_2.demoStatusContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_demo_demoNotifyContract_notify.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing demo:notify...' + C.reset);
            const res = await client.api.demo.notify(ZodToCliMapper.parseOptions(o, Contract_2.demoNotifyContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_demo_demoCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing demo:create...' + C.reset);
            const res = await client.api.demo.create(ZodToCliMapper.parseOptions(o, Contract_2.demoCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_demo_demoCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing demo:find...' + C.reset);
            const res = await client.api.demo.find(ZodToCliMapper.parseOptions(o, Contract_2.demoCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_demo_demoCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing demo:find_one...' + C.reset);
            const res = await client.api.demo.find_one(ZodToCliMapper.parseOptions(o, Contract_2.demoCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_demo_demoCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing demo:count...' + C.reset);
            const res = await client.api.demo.count(ZodToCliMapper.parseOptions(o, Contract_2.demoCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_demo_demoCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing demo:get...' + C.reset);
            const res = await client.api.demo.get(ZodToCliMapper.parseOptions(o, Contract_2.demoCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_demo_demoCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing demo:update...' + C.reset);
            const res = await client.api.demo.update(ZodToCliMapper.parseOptions(o, Contract_2.demoCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_demo_demoCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing demo:delete...' + C.reset);
            const res = await client.api.demo.delete(ZodToCliMapper.parseOptions(o, Contract_2.demoCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_inferChatContract_chat.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer:chat...' + C.reset);
            const res = await client.api.infer.chat(ZodToCliMapper.parseOptions(o, Contract_3.inferChatContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_inferApproveToolContract_approve_tool.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer:approve_tool...' + C.reset);
            const res = await client.api.infer.approve_tool(ZodToCliMapper.parseOptions(o, Contract_3.inferApproveToolContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_inferRefreshInventoryContract_refresh_inventory.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer:refresh_inventory...' + C.reset);
            const res = await client.api.infer.refresh_inventory(ZodToCliMapper.parseOptions(o, Contract_3.inferRefreshInventoryContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_inferAcquireOllamaContract_acquire_ollama.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer:acquire_ollama...' + C.reset);
            const res = await client.api.infer.acquire_ollama(ZodToCliMapper.parseOptions(o, Contract_3.inferAcquireOllamaContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_inferReleaseOllamaContract_release_ollama.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer:release_ollama...' + C.reset);
            const res = await client.api.infer.release_ollama(ZodToCliMapper.parseOptions(o, Contract_3.inferReleaseOllamaContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_inferStructuredChatContract_structured_chat.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer:structured_chat...' + C.reset);
            const res = await client.api.infer.structured_chat(ZodToCliMapper.parseOptions(o, Contract_3.inferStructuredChatContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_inferRejectToolContract_reject_tool.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer:reject_tool...' + C.reset);
            const res = await client.api.infer.reject_tool(ZodToCliMapper.parseOptions(o, Contract_3.inferRejectToolContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_inferQueueStatusContract_queue_status.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer:queue_status...' + C.reset);
            const res = await client.api.infer.queue_status(ZodToCliMapper.parseOptions(o, Contract_3.inferQueueStatusContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_ollama_ollamaCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing ollama:create...' + C.reset);
            const res = await client.api.ollama.create(ZodToCliMapper.parseOptions(o, Contract_3.ollamaCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_ollama_ollamaCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing ollama:find...' + C.reset);
            const res = await client.api.ollama.find(ZodToCliMapper.parseOptions(o, Contract_3.ollamaCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_ollama_ollamaCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing ollama:find_one...' + C.reset);
            const res = await client.api.ollama.find_one(ZodToCliMapper.parseOptions(o, Contract_3.ollamaCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_ollama_ollamaCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing ollama:count...' + C.reset);
            const res = await client.api.ollama.count(ZodToCliMapper.parseOptions(o, Contract_3.ollamaCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_ollama_ollamaCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing ollama:get...' + C.reset);
            const res = await client.api.ollama.get(ZodToCliMapper.parseOptions(o, Contract_3.ollamaCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_ollama_ollamaCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing ollama:update...' + C.reset);
            const res = await client.api.ollama.update(ZodToCliMapper.parseOptions(o, Contract_3.ollamaCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_ollama_ollamaCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing ollama:delete...' + C.reset);
            const res = await client.api.ollama.delete(ZodToCliMapper.parseOptions(o, Contract_3.ollamaCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_models_modelCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing models:create...' + C.reset);
            const res = await client.api.models.create(ZodToCliMapper.parseOptions(o, Contract_3.modelCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_models_modelCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing models:find...' + C.reset);
            const res = await client.api.models.find(ZodToCliMapper.parseOptions(o, Contract_3.modelCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_models_modelCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing models:find_one...' + C.reset);
            const res = await client.api.models.find_one(ZodToCliMapper.parseOptions(o, Contract_3.modelCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_models_modelCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing models:count...' + C.reset);
            const res = await client.api.models.count(ZodToCliMapper.parseOptions(o, Contract_3.modelCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_models_modelCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing models:get...' + C.reset);
            const res = await client.api.models.get(ZodToCliMapper.parseOptions(o, Contract_3.modelCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_models_modelCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing models:update...' + C.reset);
            const res = await client.api.models.update(ZodToCliMapper.parseOptions(o, Contract_3.modelCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_models_modelCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing models:delete...' + C.reset);
            const res = await client.api.models.delete(ZodToCliMapper.parseOptions(o, Contract_3.modelCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_threads_threadCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing threads:create...' + C.reset);
            const res = await client.api.threads.create(ZodToCliMapper.parseOptions(o, Contract_3.threadCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_threads_threadCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing threads:find...' + C.reset);
            const res = await client.api.threads.find(ZodToCliMapper.parseOptions(o, Contract_3.threadCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_threads_threadCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing threads:find_one...' + C.reset);
            const res = await client.api.threads.find_one(ZodToCliMapper.parseOptions(o, Contract_3.threadCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_threads_threadCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing threads:count...' + C.reset);
            const res = await client.api.threads.count(ZodToCliMapper.parseOptions(o, Contract_3.threadCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_threads_threadCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing threads:get...' + C.reset);
            const res = await client.api.threads.get(ZodToCliMapper.parseOptions(o, Contract_3.threadCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_threads_threadCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing threads:update...' + C.reset);
            const res = await client.api.threads.update(ZodToCliMapper.parseOptions(o, Contract_3.threadCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_threads_threadCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing threads:delete...' + C.reset);
            const res = await client.api.threads.delete(ZodToCliMapper.parseOptions(o, Contract_3.threadCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_messages_messageCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing messages:create...' + C.reset);
            const res = await client.api.messages.create(ZodToCliMapper.parseOptions(o, Contract_3.messageCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_messages_messageCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing messages:find...' + C.reset);
            const res = await client.api.messages.find(ZodToCliMapper.parseOptions(o, Contract_3.messageCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_messages_messageCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing messages:find_one...' + C.reset);
            const res = await client.api.messages.find_one(ZodToCliMapper.parseOptions(o, Contract_3.messageCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_messages_messageCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing messages:count...' + C.reset);
            const res = await client.api.messages.count(ZodToCliMapper.parseOptions(o, Contract_3.messageCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_messages_messageCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing messages:get...' + C.reset);
            const res = await client.api.messages.get(ZodToCliMapper.parseOptions(o, Contract_3.messageCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_messages_messageCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing messages:update...' + C.reset);
            const res = await client.api.messages.update(ZodToCliMapper.parseOptions(o, Contract_3.messageCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_messages_messageCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing messages:delete...' + C.reset);
            const res = await client.api.messages.delete(ZodToCliMapper.parseOptions(o, Contract_3.messageCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_tool_calls_toolCallCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing tool_calls:create...' + C.reset);
            const res = await client.api.tool_calls.create(ZodToCliMapper.parseOptions(o, Contract_3.toolCallCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_tool_calls_toolCallCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing tool_calls:find...' + C.reset);
            const res = await client.api.tool_calls.find(ZodToCliMapper.parseOptions(o, Contract_3.toolCallCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_tool_calls_toolCallCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing tool_calls:find_one...' + C.reset);
            const res = await client.api.tool_calls.find_one(ZodToCliMapper.parseOptions(o, Contract_3.toolCallCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_tool_calls_toolCallCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing tool_calls:count...' + C.reset);
            const res = await client.api.tool_calls.count(ZodToCliMapper.parseOptions(o, Contract_3.toolCallCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_tool_calls_toolCallCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing tool_calls:get...' + C.reset);
            const res = await client.api.tool_calls.get(ZodToCliMapper.parseOptions(o, Contract_3.toolCallCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_tool_calls_toolCallCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing tool_calls:update...' + C.reset);
            const res = await client.api.tool_calls.update(ZodToCliMapper.parseOptions(o, Contract_3.toolCallCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_tool_calls_toolCallCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing tool_calls:delete...' + C.reset);
            const res = await client.api.tool_calls.delete(ZodToCliMapper.parseOptions(o, Contract_3.toolCallCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_queue_inferQueueCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer_queue:create...' + C.reset);
            const res = await client.api.infer_queue.create(ZodToCliMapper.parseOptions(o, Contract_3.inferQueueCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_queue_inferQueueCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer_queue:find...' + C.reset);
            const res = await client.api.infer_queue.find(ZodToCliMapper.parseOptions(o, Contract_3.inferQueueCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_queue_inferQueueCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer_queue:find_one...' + C.reset);
            const res = await client.api.infer_queue.find_one(ZodToCliMapper.parseOptions(o, Contract_3.inferQueueCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_queue_inferQueueCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer_queue:count...' + C.reset);
            const res = await client.api.infer_queue.count(ZodToCliMapper.parseOptions(o, Contract_3.inferQueueCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_queue_inferQueueCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer_queue:get...' + C.reset);
            const res = await client.api.infer_queue.get(ZodToCliMapper.parseOptions(o, Contract_3.inferQueueCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_queue_inferQueueCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer_queue:update...' + C.reset);
            const res = await client.api.infer_queue.update(ZodToCliMapper.parseOptions(o, Contract_3.inferQueueCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_infer_queue_inferQueueCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing infer_queue:delete...' + C.reset);
            const res = await client.api.infer_queue.delete(ZodToCliMapper.parseOptions(o, Contract_3.inferQueueCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_journal_journalNoteContract_note.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing journal:note...' + C.reset);
            const res = await client.api.journal.note(ZodToCliMapper.parseOptions(o, Contract_4.journalNoteContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_journal_journalResolveContract_resolve.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing journal:resolve...' + C.reset);
            const res = await client.api.journal.resolve(ZodToCliMapper.parseOptions(o, Contract_4.journalResolveContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_journal_journalCompressContract_compress.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing journal:compress...' + C.reset);
            const res = await client.api.journal.compress(ZodToCliMapper.parseOptions(o, Contract_4.journalCompressContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_journal_journalCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing journal:create...' + C.reset);
            const res = await client.api.journal.create(ZodToCliMapper.parseOptions(o, Contract_4.journalCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_journal_journalCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing journal:find...' + C.reset);
            const res = await client.api.journal.find(ZodToCliMapper.parseOptions(o, Contract_4.journalCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_journal_journalCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing journal:find_one...' + C.reset);
            const res = await client.api.journal.find_one(ZodToCliMapper.parseOptions(o, Contract_4.journalCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_journal_journalCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing journal:count...' + C.reset);
            const res = await client.api.journal.count(ZodToCliMapper.parseOptions(o, Contract_4.journalCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_journal_journalCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing journal:get...' + C.reset);
            const res = await client.api.journal.get(ZodToCliMapper.parseOptions(o, Contract_4.journalCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_journal_journalCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing journal:update...' + C.reset);
            const res = await client.api.journal.update(ZodToCliMapper.parseOptions(o, Contract_4.journalCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_journal_journalCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing journal:delete...' + C.reset);
            const res = await client.api.journal.delete(ZodToCliMapper.parseOptions(o, Contract_4.journalCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_directive_directiveCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing directive:create...' + C.reset);
            const res = await client.api.directive.create(ZodToCliMapper.parseOptions(o, Contract_4.directiveCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_directive_directiveCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing directive:find...' + C.reset);
            const res = await client.api.directive.find(ZodToCliMapper.parseOptions(o, Contract_4.directiveCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_directive_directiveCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing directive:find_one...' + C.reset);
            const res = await client.api.directive.find_one(ZodToCliMapper.parseOptions(o, Contract_4.directiveCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_directive_directiveCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing directive:count...' + C.reset);
            const res = await client.api.directive.count(ZodToCliMapper.parseOptions(o, Contract_4.directiveCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_directive_directiveCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing directive:get...' + C.reset);
            const res = await client.api.directive.get(ZodToCliMapper.parseOptions(o, Contract_4.directiveCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_directive_directiveCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing directive:update...' + C.reset);
            const res = await client.api.directive.update(ZodToCliMapper.parseOptions(o, Contract_4.directiveCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_directive_directiveCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing directive:delete...' + C.reset);
            const res = await client.api.directive.delete(ZodToCliMapper.parseOptions(o, Contract_4.directiveCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_kanbanMoveContract_move.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban:move...' + C.reset);
            const res = await client.api.kanban.move(ZodToCliMapper.parseOptions(o, Contract_5.kanbanMoveContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_project_kanbanProjectCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_project:create...' + C.reset);
            const res = await client.api.kanban_project.create(ZodToCliMapper.parseOptions(o, Contract_5.kanbanProjectCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_project_kanbanProjectCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_project:find...' + C.reset);
            const res = await client.api.kanban_project.find(ZodToCliMapper.parseOptions(o, Contract_5.kanbanProjectCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_project_kanbanProjectCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_project:find_one...' + C.reset);
            const res = await client.api.kanban_project.find_one(ZodToCliMapper.parseOptions(o, Contract_5.kanbanProjectCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_project_kanbanProjectCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_project:count...' + C.reset);
            const res = await client.api.kanban_project.count(ZodToCliMapper.parseOptions(o, Contract_5.kanbanProjectCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_project_kanbanProjectCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_project:get...' + C.reset);
            const res = await client.api.kanban_project.get(ZodToCliMapper.parseOptions(o, Contract_5.kanbanProjectCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_project_kanbanProjectCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_project:update...' + C.reset);
            const res = await client.api.kanban_project.update(ZodToCliMapper.parseOptions(o, Contract_5.kanbanProjectCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_project_kanbanProjectCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_project:delete...' + C.reset);
            const res = await client.api.kanban_project.delete(ZodToCliMapper.parseOptions(o, Contract_5.kanbanProjectCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_feature_kanbanFeatureCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_feature:create...' + C.reset);
            const res = await client.api.kanban_feature.create(ZodToCliMapper.parseOptions(o, Contract_5.kanbanFeatureCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_feature_kanbanFeatureCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_feature:find...' + C.reset);
            const res = await client.api.kanban_feature.find(ZodToCliMapper.parseOptions(o, Contract_5.kanbanFeatureCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_feature_kanbanFeatureCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_feature:find_one...' + C.reset);
            const res = await client.api.kanban_feature.find_one(ZodToCliMapper.parseOptions(o, Contract_5.kanbanFeatureCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_feature_kanbanFeatureCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_feature:count...' + C.reset);
            const res = await client.api.kanban_feature.count(ZodToCliMapper.parseOptions(o, Contract_5.kanbanFeatureCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_feature_kanbanFeatureCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_feature:get...' + C.reset);
            const res = await client.api.kanban_feature.get(ZodToCliMapper.parseOptions(o, Contract_5.kanbanFeatureCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_feature_kanbanFeatureCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_feature:update...' + C.reset);
            const res = await client.api.kanban_feature.update(ZodToCliMapper.parseOptions(o, Contract_5.kanbanFeatureCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_feature_kanbanFeatureCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_feature:delete...' + C.reset);
            const res = await client.api.kanban_feature.delete(ZodToCliMapper.parseOptions(o, Contract_5.kanbanFeatureCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_work_item_kanbanWorkItemCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_work_item:create...' + C.reset);
            const res = await client.api.kanban_work_item.create(ZodToCliMapper.parseOptions(o, Contract_5.kanbanWorkItemCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_work_item_kanbanWorkItemCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_work_item:find...' + C.reset);
            const res = await client.api.kanban_work_item.find(ZodToCliMapper.parseOptions(o, Contract_5.kanbanWorkItemCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_work_item_kanbanWorkItemCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_work_item:find_one...' + C.reset);
            const res = await client.api.kanban_work_item.find_one(ZodToCliMapper.parseOptions(o, Contract_5.kanbanWorkItemCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_work_item_kanbanWorkItemCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_work_item:count...' + C.reset);
            const res = await client.api.kanban_work_item.count(ZodToCliMapper.parseOptions(o, Contract_5.kanbanWorkItemCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_work_item_kanbanWorkItemCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_work_item:get...' + C.reset);
            const res = await client.api.kanban_work_item.get(ZodToCliMapper.parseOptions(o, Contract_5.kanbanWorkItemCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_work_item_kanbanWorkItemCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_work_item:update...' + C.reset);
            const res = await client.api.kanban_work_item.update(ZodToCliMapper.parseOptions(o, Contract_5.kanbanWorkItemCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_kanban_work_item_kanbanWorkItemCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing kanban_work_item:delete...' + C.reset);
            const res = await client.api.kanban_work_item.delete(ZodToCliMapper.parseOptions(o, Contract_5.kanbanWorkItemCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_manager_managerChatContract_chat.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing manager:chat...' + C.reset);
            const res = await client.api.manager.chat(ZodToCliMapper.parseOptions(o, Contract_6.managerChatContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_manager_managerPulseContract_pulse.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing manager:pulse...' + C.reset);
            const res = await client.api.manager.pulse(ZodToCliMapper.parseOptions(o, Contract_6.managerPulseContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_manager_managerInquireContract_inquire.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing manager:inquire...' + C.reset);
            const res = await client.api.manager.inquire(ZodToCliMapper.parseOptions(o, Contract_6.managerInquireContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_manager_managerExecuteContract_execute.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing manager:execute...' + C.reset);
            const res = await client.api.manager.execute(ZodToCliMapper.parseOptions(o, Contract_6.managerExecuteContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_manager_managerResearchContract_research.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing manager:research...' + C.reset);
            const res = await client.api.manager.research(ZodToCliMapper.parseOptions(o, Contract_6.managerResearchContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_manager_managerRunContract_run.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing manager:run...' + C.reset);
            const res = await client.api.manager.run(ZodToCliMapper.parseOptions(o, Contract_6.managerRunContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_manager_managerListToolErrorsContract_list_tool_errors.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing manager:list_tool_errors...' + C.reset);
            const res = await client.api.manager.list_tool_errors(ZodToCliMapper.parseOptions(o, Contract_6.managerListToolErrorsContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_manager_managerLoadPromptsContract_load_prompts.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing manager:load_prompts...' + C.reset);
            const res = await client.api.manager.load_prompts(ZodToCliMapper.parseOptions(o, Contract_6.managerLoadPromptsContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_manager_managerEvaluateApprovalContract_evaluate_approval.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing manager:evaluate_approval...' + C.reset);
            const res = await client.api.manager.evaluate_approval(ZodToCliMapper.parseOptions(o, Contract_6.managerEvaluateApprovalContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_pulse_report_pulseReportCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing pulse_report:create...' + C.reset);
            const res = await client.api.pulse_report.create(ZodToCliMapper.parseOptions(o, Contract_6.pulseReportCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_pulse_report_pulseReportCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing pulse_report:find...' + C.reset);
            const res = await client.api.pulse_report.find(ZodToCliMapper.parseOptions(o, Contract_6.pulseReportCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_pulse_report_pulseReportCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing pulse_report:find_one...' + C.reset);
            const res = await client.api.pulse_report.find_one(ZodToCliMapper.parseOptions(o, Contract_6.pulseReportCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_pulse_report_pulseReportCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing pulse_report:count...' + C.reset);
            const res = await client.api.pulse_report.count(ZodToCliMapper.parseOptions(o, Contract_6.pulseReportCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_pulse_report_pulseReportCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing pulse_report:get...' + C.reset);
            const res = await client.api.pulse_report.get(ZodToCliMapper.parseOptions(o, Contract_6.pulseReportCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_pulse_report_pulseReportCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing pulse_report:update...' + C.reset);
            const res = await client.api.pulse_report.update(ZodToCliMapper.parseOptions(o, Contract_6.pulseReportCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_pulse_report_pulseReportCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing pulse_report:delete...' + C.reset);
            const res = await client.api.pulse_report.delete(ZodToCliMapper.parseOptions(o, Contract_6.pulseReportCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_marketplace_marketplaceListContract_list.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing marketplace:list...' + C.reset);
            const res = await client.api.marketplace.list(ZodToCliMapper.parseOptions(o, Contract_7.marketplaceListContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_marketplace_marketplaceInstallContract_install.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing marketplace:install...' + C.reset);
            const res = await client.api.marketplace.install(ZodToCliMapper.parseOptions(o, Contract_7.marketplaceInstallContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_notifications_notificationsSendContract_send.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing notifications:send...' + C.reset);
            const res = await client.api.notifications.send(ZodToCliMapper.parseOptions(o, Contract_8.notificationsSendContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_notifications_notificationsListContract_list.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing notifications:list...' + C.reset);
            const res = await client.api.notifications.list(ZodToCliMapper.parseOptions(o, Contract_8.notificationsListContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxSetActiveContract_set_active.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:set_active...' + C.reset);
            const res = await client.api.sandbox.set_active(ZodToCliMapper.parseOptions(o, Contract_9.sandboxSetActiveContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxPruneContract_prune.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:prune...' + C.reset);
            const res = await client.api.sandbox.prune(ZodToCliMapper.parseOptions(o, Contract_9.sandboxPruneContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxFsReadContract_fs_read.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:fs_read...' + C.reset);
            const res = await client.api.sandbox.fs_read(ZodToCliMapper.parseOptions(o, Contract_9.sandboxFsReadContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxFsWriteContract_fs_write.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:fs_write...' + C.reset);
            const res = await client.api.sandbox.fs_write(ZodToCliMapper.parseOptions(o, Contract_9.sandboxFsWriteContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxFsListContract_fs_list.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:fs_list...' + C.reset);
            const res = await client.api.sandbox.fs_list(ZodToCliMapper.parseOptions(o, Contract_9.sandboxFsListContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxFsPatchContract_fs_patch.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:fs_patch...' + C.reset);
            const res = await client.api.sandbox.fs_patch(ZodToCliMapper.parseOptions(o, Contract_9.sandboxFsPatchContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxFsRemoveContract_fs_remove.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:fs_remove...' + C.reset);
            const res = await client.api.sandbox.fs_remove(ZodToCliMapper.parseOptions(o, Contract_9.sandboxFsRemoveContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxFsMkdirContract_fs_mkdir.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:fs_mkdir...' + C.reset);
            const res = await client.api.sandbox.fs_mkdir(ZodToCliMapper.parseOptions(o, Contract_9.sandboxFsMkdirContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxFsMoveContract_fs_move.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:fs_move...' + C.reset);
            const res = await client.api.sandbox.fs_move(ZodToCliMapper.parseOptions(o, Contract_9.sandboxFsMoveContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxTerminalExecuteContract_terminal_execute.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:terminal_execute...' + C.reset);
            const res = await client.api.sandbox.terminal_execute(ZodToCliMapper.parseOptions(o, Contract_9.sandboxTerminalExecuteContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxTerminalSpawnContract_terminal_spawn.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:terminal_spawn...' + C.reset);
            const res = await client.api.sandbox.terminal_spawn(ZodToCliMapper.parseOptions(o, Contract_9.sandboxTerminalSpawnContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxTerminalListContract_terminal_list.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:terminal_list...' + C.reset);
            const res = await client.api.sandbox.terminal_list(ZodToCliMapper.parseOptions(o, Contract_9.sandboxTerminalListContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxTerminalKillContract_terminal_kill.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:terminal_kill...' + C.reset);
            const res = await client.api.sandbox.terminal_kill(ZodToCliMapper.parseOptions(o, Contract_9.sandboxTerminalKillContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxTerminalLogsContract_terminal_logs.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:terminal_logs...' + C.reset);
            const res = await client.api.sandbox.terminal_logs(ZodToCliMapper.parseOptions(o, Contract_9.sandboxTerminalLogsContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxTerminalSessionOpenContract_terminal_session_open.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:terminal_session_open...' + C.reset);
            const res = await client.api.sandbox.terminal_session_open(ZodToCliMapper.parseOptions(o, Contract_9.sandboxTerminalSessionOpenContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxTerminalSessionListContract_terminal_session_list.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:terminal_session_list...' + C.reset);
            const res = await client.api.sandbox.terminal_session_list(ZodToCliMapper.parseOptions(o, Contract_9.sandboxTerminalSessionListContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxTerminalSessionWriteContract_terminal_session_write.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:terminal_session_write...' + C.reset);
            const res = await client.api.sandbox.terminal_session_write(ZodToCliMapper.parseOptions(o, Contract_9.sandboxTerminalSessionWriteContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxTerminalSessionResizeContract_terminal_session_resize.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:terminal_session_resize...' + C.reset);
            const res = await client.api.sandbox.terminal_session_resize(ZodToCliMapper.parseOptions(o, Contract_9.sandboxTerminalSessionResizeContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxNetworkExposeContract_network_expose.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:network_expose...' + C.reset);
            const res = await client.api.sandbox.network_expose(ZodToCliMapper.parseOptions(o, Contract_9.sandboxNetworkExposeContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxNetworkUnexposeContract_network_unexpose.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:network_unexpose...' + C.reset);
            const res = await client.api.sandbox.network_unexpose(ZodToCliMapper.parseOptions(o, Contract_9.sandboxNetworkUnexposeContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxNetworkListContract_network_list.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:network_list...' + C.reset);
            const res = await client.api.sandbox.network_list(ZodToCliMapper.parseOptions(o, Contract_9.sandboxNetworkListContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxNetworkSetPolicyContract_network_set_policy.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:network_set_policy...' + C.reset);
            const res = await client.api.sandbox.network_set_policy(ZodToCliMapper.parseOptions(o, Contract_9.sandboxNetworkSetPolicyContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxEnvSetContract_env_set.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:env_set...' + C.reset);
            const res = await client.api.sandbox.env_set(ZodToCliMapper.parseOptions(o, Contract_9.sandboxEnvSetContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxEnvSetSecretContract_env_set_secret.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:env_set_secret...' + C.reset);
            const res = await client.api.sandbox.env_set_secret(ZodToCliMapper.parseOptions(o, Contract_9.sandboxEnvSetSecretContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxEnvListContract_env_list.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:env_list...' + C.reset);
            const res = await client.api.sandbox.env_list(ZodToCliMapper.parseOptions(o, Contract_9.sandboxEnvListContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxResourceUpdateLimitsContract_resource_update_limits.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:resource_update_limits...' + C.reset);
            const res = await client.api.sandbox.resource_update_limits(ZodToCliMapper.parseOptions(o, Contract_9.sandboxResourceUpdateLimitsContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxResourceGetStatsContract_resource_get_stats.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:resource_get_stats...' + C.reset);
            const res = await client.api.sandbox.resource_get_stats(ZodToCliMapper.parseOptions(o, Contract_9.sandboxResourceGetStatsContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxStateCommitContract_state_commit.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:state_commit...' + C.reset);
            const res = await client.api.sandbox.state_commit(ZodToCliMapper.parseOptions(o, Contract_9.sandboxStateCommitContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxStateCloneContract_state_clone.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:state_clone...' + C.reset);
            const res = await client.api.sandbox.state_clone(ZodToCliMapper.parseOptions(o, Contract_9.sandboxStateCloneContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxCrud_create_create.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:create...' + C.reset);
            const res = await client.api.sandbox.create(ZodToCliMapper.parseOptions(o, Contract_9.sandboxCrud['create'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxCrud_find_find.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:find...' + C.reset);
            const res = await client.api.sandbox.find(ZodToCliMapper.parseOptions(o, Contract_9.sandboxCrud['find'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxCrud_findOne_find_one.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:find_one...' + C.reset);
            const res = await client.api.sandbox.find_one(ZodToCliMapper.parseOptions(o, Contract_9.sandboxCrud['findOne'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxCrud_count_count.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:count...' + C.reset);
            const res = await client.api.sandbox.count(ZodToCliMapper.parseOptions(o, Contract_9.sandboxCrud['count'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxCrud_get_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:get...' + C.reset);
            const res = await client.api.sandbox.get(ZodToCliMapper.parseOptions(o, Contract_9.sandboxCrud['get'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxCrud_update_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:update...' + C.reset);
            const res = await client.api.sandbox.update(ZodToCliMapper.parseOptions(o, Contract_9.sandboxCrud['update'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_sandbox_sandboxCrud_delete_delete.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing sandbox:delete...' + C.reset);
            const res = await client.api.sandbox.delete(ZodToCliMapper.parseOptions(o, Contract_9.sandboxCrud['delete'].inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_settings_settingsGetContract_get.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing settings:get...' + C.reset);
            const res = await client.api.settings.get(ZodToCliMapper.parseOptions(o, Contract_10.settingsGetContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_settings_settingsUpdateContract_update.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing settings:update...' + C.reset);
            const res = await client.api.settings.update(ZodToCliMapper.parseOptions(o, Contract_10.settingsUpdateContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
    ...
    cmd_settings_settingsGetAllContract_getAll.action(async (o: Record<string, unknown>) => {
        try {
            console.log(C.dim + 'Executing settings:getAll...' + C.reset);
            const res = await client.api.settings.getAll(ZodToCliMapper.parseOptions(o, Contract_10.settingsGetAllContract.inputSchema));
            console.log(JSON.stringify(res, null, 2));
            client.close();
            process.exit(0);
        } catch (err: unknown) {
