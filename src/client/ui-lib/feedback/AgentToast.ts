...
export type AgentNotificationVariant = 'info' | 'success' | 'warning' | 'error';

export interface AgentToastProps {
    message: string;
...
const VARIANT_CONFIG: Record<AgentNotificationVariant, { icon: string; color: string; bg: string }> = {
...
export class AgentToast extends BaseComponent<AgentToastProps> {
    private dismissTimer: ReturnType<typeof setTimeout> | null = null;

    constructor(props: AgentToastProps) {
        super('div', props);
        this.render();
    }
...
/**
 * AgentNotificationContainer — Manages a stack of agent toast notifications.
 */
export class AgentNotificationContainer {
    ...
    public show(props: AgentToastProps): AgentToast {
