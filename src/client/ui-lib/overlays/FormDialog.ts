...
export interface FormDialogOptions {
    ...
    cancelLabel?: string;
    fields: FormField[];
    validateForm?: (values: Record<string, unknown>) => string | null | Promise<string | null>;
}

export class FormDialog extends Modal {
    constructor(options: FormDialogOptions, resolve: (value: Record<string, unknown> | null) => void) {
        ...
        options.fields.forEach(field => {
            let control: BaseComponent<unknown>;
    ...
    public static show(options: FormDialogOptions): Promise<Record<string, unknown> | null> {
